...
namespace Cashier
{
    ...
    public class CodedUITest1
    {
        ...
        public void CloseCashHouse()
        {
            ...
            this.UIMap.CloseCashHouse();

        }
        [TestMethod]
        public void LogoutWithoutClosingSession()
        {

            this.UIMap.LogoutWithoutClosingSessions();
